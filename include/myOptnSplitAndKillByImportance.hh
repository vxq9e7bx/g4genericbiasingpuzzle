...
//
//
/// \file myOptnSplitAndKillByImportance.hh
/// \brief Definition of the myOptnSplitAndKillByImportance class

#ifndef myOptnSplitAndKillByImportance_hh
#define myOptnSplitAndKillByImportance_hh 1
...
class myOptnSplitAndKillByImportance : public G4VBiasingOperation {
public:
  // -- Constructor :
  myOptnSplitAndKillByImportance(G4String name);
  // -- destructor:
  virtual ~myOptnSplitAndKillByImportance();
